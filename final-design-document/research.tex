...
Additionally the operating system will need to have Bluetooth configured through the BlueZ
stack using the BlueZ utilities and configuration files. This configuration process is
quite extensive and is covered in more detail in \nameref{sec:ble_midi}.
