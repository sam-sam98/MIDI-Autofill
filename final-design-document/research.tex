...
\paragraph{Converting Python Trained Models to TensorFlow.js.} to work in a JavaScript
...
performance (see \nameref{figure:magenta_benchmark}) and a linear suite to find out what
