...
Although we may not end up using Magenta, it serves as a good baseline for measuring
performance of music generating AI. Magenta ships with two machine learning models:
MusicRNN and MusicVAE.

MusicRNN with the provided pretrained models has shown good performance when autofilling
simple melodies, below the 5 second threshold we set in our goals. Initial tests involved
running an autofill on Twinkle, twinkle little star. We are showing about 4 seconds to
generate 5 seconds worth of music. This is without any optimization attempts.
