...
current project. Still, some of these elements can be valuable tools to create, train, and
...
also considers processed information along large sequences of data, and not purely local
...
memory (LSTM) networks. This is a variant of RNN design to improve the performance of
regular RNN across large sequences of data. The main issues that LSTM address are those
...
PerformanceRNN generates melodies using dynamic and expressing timing. This allows us to
generate a more natural feeling as if a real player is adding to the expression of the
...
This model adds a nice to have feature, but is not fundamental for our first approach.
...
The selection of the dataset would be conditioned by the available training capabilities
for this project.
