...
\begin{table}[]
  ...
  \begin{tabular}{|l|l|l|l|l|l|l|}
    \hline
    Degree             & Name                                  & Corresponding mode (major key) & Corresponding mode (minor key) & Meaning                                                                                        & Note (in C major) & Note (in C minor) \\ \hline
    1                  & Tonic                                 & Ionian                         & Aeolian                        & Tonal center, note of final resolution                                                         & C                 & C                 \\ \hline
    2                  & Supertonic                            & Dorian                         & Locrian                        & One whole step above the tonic                                                                 & D                 & D                 \\ \hline
    3                  & Mediant                               & Phrygian                       & Ionian                         & Midway between tonic and dominant, (in minor key) root of relative major key                   & E                 & Eb                \\ \hline
    4                  & Subdominant                           & Lydian                         & Dorian                         & Lower dominant, same interval below tonic as dominant is above tonic                           & F                 & F                 \\ \hline
    5                  & Dominant                              & Mixolydian                     & Phrygian                       & Second in importance to the tonic                                                              & G                 & G                 \\ \hline
    6                  & Submediant                            & Aeolian                        & Lydian                         & Lower mediant, midway between tonic and subdominant, (in major key) root of relative minor key & A                 & Ab                \\ \hline
    \multirow{2}{*}{7} & Subtonic (in the natural minor scale) &                                & Mixolydian                     & One whole step below tonic in natural minor scale.                                             &                   & Bb                \\ \cline{2-7}
                       & Leading tone (in the major scale)     & Locrian                        &                                & One half step below tonic. Melodically strong affinity for and leads to tonic                  & B                 &                   \\ \hline
    1                  & Tonic (octave)                        & Ionian                         & Aeolian                        & Tonal center, note of final resolution                                                         & C                 & C                 \\ \hline
  \end{tabular}}
  \caption{The names and meanings of degrees in the diatonic scale}
  \label{Tab:degrees}
\end{table}

According to music theory, each degree plays a different role in the scale. The tonic is
